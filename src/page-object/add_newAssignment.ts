...
export class AddNewAssignment {
    ...
    constructor (page:Page){
        ...
        this.storeName_box = page.getByRole('textbox', { name: 'Store Name', exact: true })
        this.customerName_box = page.getByRole('textbox', { name: 'Customer Name', exact: true })
        this.knownStoreName_box = page.getByRole('textbox', { name: 'Known Store Name', exact: true })
        this.customerId_box = page.getByRole('textbox', { name: 'Customer ID', exact: true })
        this.firstName_box = page.getByRole('textbox', { name: 'First Name', exact: true })
        this.lastName_box = page.getByRole('textbox',{name: 'Last Name', exact: true})
        this.phoneNumber_box = page.getByRole('textbox',{name: 'Phone Number', exact: true})
        this.secondaryPhoneNumber = page.getByRole('textbox',{name: 'Secondary Phone Number', exact: true})
        this.address_box = page.getByRole('textbox',{name: 'Address', exact: true})
        this.district_box = page.getByRole('textbox',{name: 'District', exact: true})
        this.province_box = page.getByRole('textbox',{name: 'Province', exact: true})
        this.postCode_box = page.getByRole('textbox',{name: 'Post Code', exact: true})
        this.latitude_box = page.getByRole('textbox',{name: 'Latitude', exact: true})
        this.longtitude_box = page.getByRole('textbox',{name: 'Longitude', exact: true})
        ...
        this.customerStatus_box = page.getByRole('textbox',{name: "Customer Status"})
        this.registeredDate_selected = page.locator('//*[@id="RegisteredDate"]')
        this.registeredBy_box = page.getByRole('textbox',{name:'Registered By'})
        this.outletMaster_box = page.getByRole('textbox',{name:'Outlet Master'})
        ...
        this.subtradeChannelID_box = page.getByRole('textbox',{name:'Subtrade Channel ID'})
        this.frequencyGroupOfRepeatsPurchased_box = page.getByRole('textbox',{name:'Frequency Group of Repeats Purchased'})
        this.visitWeek_box = page.getByRole('textbox',{name:'Visit Weeks', exact:true})
        this.visitFrequency_box = page.getByRole('textbox',{name:'Visit Frequency', exact:true})
        this.visitEvery_box = page.getByRole('textbox',{name:'Visit Every', exact:true})
        this.customerType_box = page.getByRole('textbox',{name:'Customer Type',exact:true})
        this.ownerRole_box = page.getByRole('textbox',{name:'Owner Role',exact:true})
        this.ownerName_box = page.getByRole('textbox',{name:'Owner Name',exact:true})
        this.ownerEmail_box = page.getByRole('textbox',{name:'Owner Email',exact:true})
        this.visitBy_box = page.getByRole('textbox',{name:'Visit By',exact:true})
        this.salesRoute_box = page.getByRole('textbox',{name:'Sales Route',exact:true})
        this.RDWeeks_box = page.getByRole('textbox',{name:'RD Weeks',exact:true})
        this.RDFrequency_box = page.getByRole('textbox',{name:'RD Frequency',exact:true})
        this.RDEvery_box = page.getByRole('textbox',{name:'RD Every',exact:true})
        this.visitMonth_box = page.getByRole('textbox',{name:'Visit Month',exact:true})
        this.startVisit_button = page.getByRole('button', { name: 'Start Visit', exact:true })
    ...
    async selectAddNewForCreateVisitPlanManual(){
        ...
        await expect(this.page).toHaveURL(urlSaleForcecEnvUAT.saleForce_Addassignment_Page)
    }
    ...
    async FillFrequencyGroupOfRepeatsPurchasedInVisitPlan(FrequencyGroupOfRepeatsPurchased:string){
        await this.frequencyGroupOfRepeatsPurchased_box.fill(FrequencyGroupOfRepeatsPurchased)
    ...
    async ClickStartVisitPlan(){
        ...
        await expect(this.page).toHaveURL(urlSaleForcecEnvUAT.saleForce_Allassign_HomePage)
    }
